module.exports = {
    ...
    execute(client, message, args, Discord, cmd){
        ...
        "In the middle of difficulty lies opportunity.", "Free spot avalible, DM me to put in some good vibes (DM Mr. Stark75)", "Nutsacks (Adel requested)", ":eye:", "Your :cool:", "Life is too short to always be serious at all times.",
